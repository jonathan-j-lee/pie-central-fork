...
DeviceUID::DeviceUID(device_id_t device_id, uint8_t year, uint64_t random) {
...
bool Message::read_sub_res(param_map_t *params, interval_t *interval, DeviceUID *uid) {
    size_t offset = sizeof(*params) + sizeof(*interval);
